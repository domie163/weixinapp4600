<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="nonghuzhanghao">
          <el-input v-model="ruleForm.nonghuzhanghao" 
              placeholder="商户名称" clearable  :readonly="ro.nonghuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="nonghuzhanghao">
              <el-input v-model="ruleForm.nonghuzhanghao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssmh27ly/upload');
        } else {
