      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="农户账号" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.nonghuzhanghao" autocomplete="off" placeholder="农户账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='nonghu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="农户姓名" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.nonghuxingming" autocomplete="off" placeholder="农户姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='nonghu'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='nonghu'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='nonghu'" class="input-group">
